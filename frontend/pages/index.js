  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
      ...
      <div className="bg-white shadow-lg border-b-4 border-emerald-500">
        <div className="container mx-auto px-6 py-8">
          ...
          <p className="text-gray-600 text-center mt-2">
            Upload, search, and listen to beautiful Quran recitations
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-8 max-w-6xl">
            ...
            <form onSubmit={handleSearch} className="space-y-6">
              <div className="relative" ref={searchRef}>
                ...
                <input
                  ...
                  onFocus={() =>
                    search && suggestions.length > 0 && setShowSuggestions(true)
                  }
        ...
        {!isSearching && (!results || results.length === 0) && search.trim() && (
          <div className="bg-white rounded-2xl shadow-xl p-12 border border-gray-100 text-center">
            <div className="bg-gray-100 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0120 12c0-4.411-3.589-8-8-8s-8 3.589-8 8c0 2.152.851 4.103 2.233 5.535"
                />
              </svg>
            </div>
            ...
            <p className="text-gray-500">
              Try searching with a different surah name.
            </p>
          </div>
        )}
      </div>
  ...
  return (
    <div className="space-y-3">
      ...
      <audio
        ...
        style={{
          filter:
            "sepia(20%) saturate(70%) hue-rotate(88deg) brightness(119%) contrast(119%)",
        }}
      >
        <source src={audioUrl} />
